...
const Positioner = rewire('../../../../commonjs/positioner/src/Positioner')
const _getRequireWildcardCache = Positioner.__get__('_getRequireWildcardCache')
const _interopRequireWildcard = Positioner.__get__('_interopRequireWildcard')
...
describe('getCSS', () => {
  ...
  test('5', () => {
    const result = getCSS({ animationDuration: -Infinity, initialScale: '' })
    expect(result).toMatchSnapshot()
  })
})
