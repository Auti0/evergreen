...
describe("_interopRequireWildcard", () => {
    test("0", () => {
        let result = _interopRequireWildcard(["\"\"2006-01-02T14:04:05.000Z\"\"", "\"[3,\"false\",false]\"", "\"{\"x\":[10,null,null,null]}\"", "\"[3,\"false\",false]\""], "role")
        expect(result).toMatchSnapshot()
    })

    test("1", () => {
        let result = _interopRequireWildcard(["\"{\"x\":5,\"y\":6}\"", "\"[3,\"false\",false]\"", "\"[3,\"false\",false]\"", "\"\"2006-01-02T14:04:05.000Z\"\""], "value")
        expect(result).toMatchSnapshot()
    })
    ...
    test("3", () => {
        let result = _interopRequireWildcard(["\"[3,\"false\",false]\"", "\"\"2006-01-02T14:04:05.000Z\"\"", "\"\"2006-01-02T14:04:05.000Z\"\"", "\"{\"x\":[10,null,null,null]}\""], "action")
        expect(result).toMatchSnapshot()
    })
...
describe("Button.getIconSizeForButton", () => {
    ...
    test("1", () => {
        let result = Button.getIconSizeForButton(49.0)
        expect(result).toMatchSnapshot()
    })

    test("2", () => {
        let result = Button.getIconSizeForButton(40.0)
        expect(result).toMatchSnapshot()
    })
    ...
    test("4", () => {
        let result = Button.getIconSizeForButton(30.0)
        expect(result).toMatchSnapshot()
    })
